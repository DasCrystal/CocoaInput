...
public final class WinController implements CocoaInputController {
    ...
    public WinController() {
        ...
        Handle.INSTANCE.initialize(org.lwjgl.glfw.GLFWNativeWin32.glfwGetWin32Window(MinecraftClient.getInstance().getWindow().getHandle()), pc, dc, rc, Logger.clangLog, Logger.clangError, Logger.clangDebug);
    }
